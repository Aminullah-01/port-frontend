...
export const authApi = {
  ...
  logout: () =>
    apiClient<null>('/logout', { method: 'POST' }),
  user: () =>
    apiClient<User>('/user'),
};
...
export const settingsApi = {
  get: () =>
    apiClient<SettingData>('/settings'),
...
export const projectsApi = {
  ...
  get: (slug: string) =>
    apiClient<ProjectData>(`/projects/${slug}`),
  create: (data: FormData) =>
    apiClient<ProjectData>('/projects', { method: 'POST', body: data }),
  update: (id: number, data: FormData) =>
    apiClient<ProjectData>(`/projects/${id}`, { method: 'POST', body: data }),
  delete: (id: number) =>
    apiClient<null>(`/projects/${id}`, { method: 'DELETE' }),
};
...
export const blogsApi = {
  ...
  get: (id: number) =>
    apiClient<BlogData>(`/blogs/${id}`),
  create: (data: FormData) =>
    apiClient<BlogData>('/blogs', { method: 'POST', body: data }),
  update: (id: number, data: FormData) =>
    apiClient<BlogData>(`/blogs/${id}`, { method: 'POST', body: data }),
  delete: (id: number) =>
    apiClient<null>(`/blogs/${id}`, { method: 'DELETE' }),
};
...
export const servicesApi = {
  ...
  get: (id: number) =>
    apiClient<ServiceData>(`/services/${id}`),
  create: (data: Record<string, unknown>) =>
  ...
  delete: (id: number) =>
    apiClient<null>(`/services/${id}`, { method: 'DELETE' }),
};
...
export const certificatesApi = {
  ...
  get: (id: number) =>
    apiClient<CertificateData>(`/certificates/${id}`),
  create: (data: FormData) =>
  ...
  delete: (id: number) =>
    apiClient<null>(`/certificates/${id}`, { method: 'DELETE' }),
};
...
export const contactApi = {
  ...
  get: (id: number) =>
    apiClient<ContactMessageData>(`/contact/${id}`),
  markAsRead: (id: number) =>
    apiClient<ContactMessageData>(`/contact/${id}/read`, { method: 'POST' }),
  delete: (id: number) =>
    apiClient<null>(`/contact/${id}`, { method: 'DELETE' }),
};
